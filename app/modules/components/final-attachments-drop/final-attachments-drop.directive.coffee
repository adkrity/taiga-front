...
FinalAttachmentsDropDirective = ($parse) ->
    link = (scope, el, attrs) ->
        eventAttr = $parse(attrs.tgFinalAttachmentsDrop)
...
FinalAttachmentsDropDirective.$inject = [
    "$parse"
]

angular.module("taigaComponents").directive("tgFinalAttachmentsDrop", FinalAttachmentsDropDirective)
