...
class FinalAttachmentController
    ...
    constructor: (@attachmentsService, @translate) ->
        ...
        @.title = @translate.instant("FINAL_ATTACHMENT.TITLE", {
            fileName: @.attachment.get('name'),
            date: moment(@.attachment.get('created_date')).format(@translate.instant("FINAL_ATTACHMENT.DATE"))
        })
...
angular.module('taigaComponents').controller('FinalAttachment', FinalAttachmentController)
