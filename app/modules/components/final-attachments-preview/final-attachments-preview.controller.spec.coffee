...
describe "FinalAttachmentsPreviewController", ->
    $provide = null
    $controller = null
    scope = null
    mocks = {}
    ...
    _mockAttachmentsPreviewService = ->
        ...
        $provide.value("tgFinalAttachmentsPreviewService", mocks.attachmentsPreviewService)
    ...
    it "get current file", () ->
        ...
        ctrl = $controller("FinalAttachmentsPreview", {
            $scope: scope
        })
