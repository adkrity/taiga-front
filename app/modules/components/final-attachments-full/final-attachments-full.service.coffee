...
class FinalAttachmentsFullService extends taiga.Service
    @.$inject = [
...
angular.module("taigaComponents").service("tgFinalAttachmentsFullService", FinalAttachmentsFullService)
